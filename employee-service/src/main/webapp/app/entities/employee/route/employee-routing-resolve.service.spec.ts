...
describe('Service Tests', () => {
  describe('Employee routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IEmployee for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Employee(id) })));
        ...
        expect(resultEmployee).toEqual(new Employee(123));
      });
