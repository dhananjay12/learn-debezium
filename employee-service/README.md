...
which will open things on http://localhost:8080/ which is your backend, serving FE as well.
Note - this will not change FE dynamically if you change something in IDE.
...
will open http://localhost:9000/ which is FE in hot reload mode.
http://localhost:3001/ - will get you browser sync UI
